...
function SideBar({category}) {
  ...
  return (
    <div className="w-80  p-4  bg-slate-50">
      ...
      <div class="font-semibold">Suitcases</div>
      <ul class="px-4 cursor-pointer">
      ...
      <div class="font-semibold">Trolleys</div>
      <ul class="px-4 cursor-pointer">
      ...
      <div class="font-semibold">Shoes</div>
      <ul class="px-4 cursor-pointer">
      ...
      <div class="font-semibold">Tech Gear</div>
      <ul class="px-4 cursor-pointer">
