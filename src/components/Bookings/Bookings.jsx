    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        <div className="rounded-lg shadow-lg p-4">
          ...
          {packages.length ?  packages.map((booking) => (
            <div
              key={booking.id}
              className="bg-white shadow-lg rounded-lg p-6 mb-6 transform transition duration-500 hover:scale-105"
            >
              <div className=" mb-4">
          ...
          )) : <div className="w-full h-40 flex justify-center items-center text-xl">No bookings</div>}
        </div>
        <div className="rounded-lg shadow-lg p-4">
          <h2 className="text-3xl font-semibold text-gray-500 mb-4">
            Shopping Cart
          ...
          )) : <div className="w-full h-40 flex justify-center items-center text-xl">No Items in the Cart</div>}
        </div>
      </div>
    </div>
  );
